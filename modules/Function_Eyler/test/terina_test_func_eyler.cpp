...
TEST(Terina_Alina_EylerTest, can_check_the_property_of_eyler_function) {    //phi(2^20)= 2^(20-1);
    Function_Eyler f1;
    Function_Eyler f2;
...
TEST(Terina_Alina_EylerTest, can_check_the_property_of_Ferma_small_theorem) {  // a^phi(b)= 1{modulo b}, NOD(A,B) = 1;
    Function_Eyler f;
...
TEST(Terina_Alina_EylerTest, can_calculate_a_function_of_mutually_simple_numbers) {
    Function_Eyler f;
...
TEST(Terina_Alina_EylerTest, can_calculate_a_function_of_mutually_simple_numbers_1) {
    Function_Eyler f;
